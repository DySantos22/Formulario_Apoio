...
<body>
    <main>
        <div class="d-flex justify-content-center container">
            <div class="col-md-5">
                <form id="formulario" name="formulario" method="POST" action="updatepassword.php">
                    ...
                    <div class="button">
                        <button type="submit" class="btn btn-primary" id="trocar" onclick="validar()">CADASTRAR SENHA</button>
                    </div>
                </form>
            </div>
        </div>
